...
#    Updated: 2017/09/22 13:35:00 by vngwalaz         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_BASE 	= ft_more_commands.c Ft_check_args.c ft_if_checks.c ft_prints.c \
			  ft_flags_file.c ft_cd.c main.c ft_getenv.c ft_more_checks_args.c
